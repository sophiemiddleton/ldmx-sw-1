...
#define EVENT_HCALDIGICOLLECTION_H_
...
namespace ldmx {
    ...
    class HcalDigiCollection {
        ...
        public:
             ...
             */
            std::vector< HcalDigiSample > getDigi( unsigned int digiIndex ) const;
             ...
             */
            void addDigi( std::vector< HcalDigiSample > newSamples );
