...
class VisiblesCutflow(ldmxcfg.Analyzer) :
    ...
    def __init__(self, name='vis') :
        ...
        self.ecal_disc_cut = 0.8#0.99741

        ## Define histograms ##

        self.build1DHistogram("totalevents", "totalevents", 40, 0, 7000)
        self.build1DHistogram("acceptance", "acceptance", 40, 0, 7000)
        self.build1DHistogram("passtrigger", "passtrigger", 40, 0, 7000)
        self.build1DHistogram("ecalenergy", "ecalenergy", 40, 0, 7000)
        self.build1DHistogram("passTrackerVeto", "passTrackerVeto", 40, 0, 7000)
        self.build1DHistogram("passEcalBDT", "passEcalBDT", 40, 0, 7000)
        self.build1DHistogram("hcalEnergyReq", "hcalEnergyReq", 40, 0, 7000)
        self.build1DHistogram("containment", "containment", 40, 0, 7000)
        self.build1DHistogram("passVisiblesBDT", "passVisiblesBDT", 40, 0, 7000)
        ...
        self.build1DHistogram("ecalDisc", "ecalDisc", 100, -1,1);
